...
type: concept
module: Notify
tags: [notify, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Notify filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Notify` estende una classe `Filament\...` direttamente.

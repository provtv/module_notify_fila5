...
=======
  - "https://github.com/laraxot/<nome repitory>/issues/272"
discussions:
...
=======
qmd search "wizard ticket" -c mod-<nome progetto> -n 5

# Ricerca semantica (vector, ~2s)
qmd vsearch "come creare una segnalazione" -c mod-<nome progetto>
>>>>>>> b05b65f05 (Refactor NotifyThemeableBusinessLogicTest to simplify factory usage and improve readability)

...
# View issues
<<<<<<< HEAD
gh issue list --repo laraxot/<nome repository> --label "design-comuni"

# Filter by priority
gh issue list --repo laraxot/<nome repository> --label "priority:critical"
=======
gh issue list --repo laraxot/<nome repitory> --label "design-comuni"

# Filter by priority
gh issue list --repo laraxot/<nome repitory> --label "priority:critical"

...
- **URL**: https://github.com/laraxot/<nome repitory>/issues/6
- **Status**: Open
...
- **URL**: https://github.com/laraxot/<nome repitory>/issues/7
- **Status**: Open
...
- **URL**: https://github.com/laraxot/<nome repitory>/issues/4
- **Status**: Completed ✅

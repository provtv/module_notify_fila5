...
✅ <nome progetto>::segnalazione.rating.feedback.text
✅ <nome progetto>::segnalazione.modal.close.label

❌ SEGNALAZIONE::SEGNALAZIONE.ELENCO.TITLE   (namespace maiuscolo, manca tipo)
❌ <nome progetto>::segnalazione.heading.title_label  (underscore invece di punto)
❌ <nome progetto>::segnalazione.fields.label         (manca chiave specifica)
>>>>>>> b05b65f05 (Refactor NotifyThemeableBusinessLogicTest to simplify factory usage and improve readability)
```

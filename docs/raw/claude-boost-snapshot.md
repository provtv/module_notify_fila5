...
<<<<<<< HEAD
Contents of /var/www/html/_bases/<nome repository>/laravel/CLAUDE.md (project instructions, checked into the codebase):
=======
Contents of /var/www/html/_bases/<nome repitory>_mono/laravel/CLAUDE.md (project instructions, checked into the codebase):

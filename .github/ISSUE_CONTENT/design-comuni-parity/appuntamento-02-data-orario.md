...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/appuntamento-02-data-orario` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/appuntamento-02-data-orario.html
- **Locale:** http://127.0.0.1:8000/it/tests/appuntamento-02-data-orario

## Descrizione
Appointment booking step 2: date/time.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/appuntamento-02-data-orario.html > docs/visual-comparison/reference-appuntamento-02-data-orario.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/appuntamento-02-data-orario > docs/visual-comparison/local-appuntamento-02-data-orario.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.appuntamento-02-data-orario.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/APPUNTAMENTO-02-DATA-ORARIO-COMPARISON.md`

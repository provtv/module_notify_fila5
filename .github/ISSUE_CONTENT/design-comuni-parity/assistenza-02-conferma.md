...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/assistenza-02-conferma` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/assistenza-02-conferma.html
- **Locale:** http://127.0.0.1:8000/it/tests/assistenza-02-conferma

## Descrizione
Support request step 2: confirmation.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/assistenza-02-conferma.html > docs/visual-comparison/reference-assistenza-02-conferma.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/assistenza-02-conferma > docs/visual-comparison/local-assistenza-02-conferma.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.assistenza-02-conferma.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/ASSISTENZA-02-CONFERMA-COMPARISON.md`

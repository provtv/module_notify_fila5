...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/appuntamento-03-dettagli` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/appuntamento-03-dettagli.html
- **Locale:** http://127.0.0.1:8000/it/tests/appuntamento-03-dettagli

## Descrizione
Appointment booking step 3: details.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/appuntamento-03-dettagli.html > docs/visual-comparison/reference-appuntamento-03-dettagli.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/appuntamento-03-dettagli > docs/visual-comparison/local-appuntamento-03-dettagli.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.appuntamento-03-dettagli.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/APPUNTAMENTO-03-DETTAGLI-COMPARISON.md`

...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/domande-frequenti` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.
...
## Descrizione
FAQ page with accordion Q&A, categories, and rating section.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/domande-frequenti.html > docs/visual-comparison/reference-domande-frequenti.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/domande-frequenti > docs/visual-comparison/local-domande-frequenti.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.domande-frequenti.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/DOMANDE-FREQUENTI-COMPARISON.md`

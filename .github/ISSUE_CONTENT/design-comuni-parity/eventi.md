# Converti pagina: Eventi (eventi.html)

## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/eventi` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/eventi.html
- **Locale:** http://127.0.0.1:8000/it/tests/eventi

## Descrizione
Events listing with calendar and filters.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/eventi.html > docs/visual-comparison/reference-eventi.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/eventi > docs/visual-comparison/local-eventi.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.eventi.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/EVENTI-COMPARISON.md`

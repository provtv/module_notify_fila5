...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/lista-risorse` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/lista-risorse.html
- **Locale:** http://127.0.0.1:8000/it/tests/lista-risorse

## Descrizione
Resources listing page with cards and filtering.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/lista-risorse.html > docs/visual-comparison/reference-lista-risorse.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/lista-risorse > docs/visual-comparison/local-lista-risorse.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.lista-risorse.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/LISTA-RISORSE-COMPARISON.md`

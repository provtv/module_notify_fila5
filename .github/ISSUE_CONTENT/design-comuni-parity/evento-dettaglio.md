...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/evento-dettaglio` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/evento-dettaglio.html
- **Locale:** http://127.0.0.1:8000/it/tests/evento-dettaglio

## Descrizione
Single event detail page.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/evento-dettaglio.html > docs/visual-comparison/reference-evento-dettaglio.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/evento-dettaglio > docs/visual-comparison/local-evento-dettaglio.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.evento-dettaglio.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/EVENTO-DETTAGLIO-COMPARISON.md`

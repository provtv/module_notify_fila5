# Converti pagina: Novità (novita.html)

## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/novita` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/novita.html
- **Locale:** http://127.0.0.1:8000/it/tests/novita

## Descrizione
News listing with cards and filters.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/novita.html > docs/visual-comparison/reference-novita.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/novita > docs/visual-comparison/local-novita.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.novita.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/NOVITA-COMPARISON.md`

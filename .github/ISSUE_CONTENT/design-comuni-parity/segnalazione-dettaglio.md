...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/segnalazione-dettaglio` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.
...
## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/segnalazione-dettaglio.html > docs/visual-comparison/reference-segnalazione-dettaglio.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/segnalazione-dettaglio > docs/visual-comparison/local-segnalazione-dettaglio.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.segnalazione-dettaglio.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/SEGNALAZIONE-DETTAGLIO-COMPARISON.md`

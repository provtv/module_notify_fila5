# Converti pagina: Segnalazione - Privacy (segnalazione-01-privacy.html)

## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/segnalazione-01-privacy` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.
...
## Descrizione
Report submission step 1: privacy.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/segnalazione-01-privacy.html > docs/visual-comparison/reference-segnalazione-01-privacy.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/segnalazione-01-privacy > docs/visual-comparison/local-segnalazione-01-privacy.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.segnalazione-01-privacy.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/SEGNALAZIONE-01-PRIVACY-COMPARISON.md`

...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/servizi-categoria` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/servizi-categoria.html
- **Locale:** http://127.0.0.1:8000/it/tests/servizi-categoria

## Descrizione
Services filtered by category.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/servizi-categoria.html > docs/visual-comparison/reference-servizi-categoria.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/servizi-categoria > docs/visual-comparison/local-servizi-categoria.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.servizi-categoria.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/SERVIZI-CATEGORIA-COMPARISON.md`

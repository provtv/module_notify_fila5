...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/segnalazione-02-dati` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.
...
## Descrizione
Report submission step 2: data.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/segnalazione-02-dati.html > docs/visual-comparison/reference-segnalazione-02-dati.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/segnalazione-02-dati > docs/visual-comparison/local-segnalazione-02-dati.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.segnalazione-02-dati.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/SEGNALAZIONE-02-DATI-COMPARISON.md`

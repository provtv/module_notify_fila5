...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/mappa-sito` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/mappa-sito.html
- **Locale:** http://127.0.0.1:8000/it/tests/mappa-sito

## Descrizione
Site map with hierarchical navigation.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/mappa-sito.html > docs/visual-comparison/reference-mappa-sito.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/mappa-sito > docs/visual-comparison/local-mappa-sito.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.mappa-sito.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/MAPPA-SITO-COMPARISON.md`

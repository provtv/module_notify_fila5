...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/servizio-dettaglio` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/servizio-dettaglio.html
- **Locale:** http://127.0.0.1:8000/it/tests/servizio-dettaglio

## Descrizione
Single service detail page with steps.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/servizio-dettaglio.html > docs/visual-comparison/reference-servizio-dettaglio.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/servizio-dettaglio > docs/visual-comparison/local-servizio-dettaglio.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.servizio-dettaglio.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/SERVIZIO-DETTAGLIO-COMPARISON.md`

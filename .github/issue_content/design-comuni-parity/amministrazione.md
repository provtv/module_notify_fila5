# Converti pagina: Amministrazione (amministrazione.html)

## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/amministrazione` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/amministrazione.html
- **Locale:** http://127.0.0.1:8000/it/tests/amministrazione

## Descrizione
Administration page with organizational structure.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/amministrazione.html > docs/visual-comparison/reference-amministrazione.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/amministrazione > docs/visual-comparison/local-amministrazione.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.amministrazione.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/AMMINISTRAZIONE-COMPARISON.md`

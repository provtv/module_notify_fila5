...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/documenti-dati` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.

## Riferimento
- **Reference:** https://italia.github.io/design-comuni-pagine-statiche/sito/documenti-dati.html
- **Locale:** http://127.0.0.1:8000/it/tests/documenti-dati

## Descrizione
Documents and data repository page.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/documenti-dati.html > docs/visual-comparison/reference-documenti-dati.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/documenti-dati > docs/visual-comparison/local-documenti-dati.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.documenti-dati.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/DOCUMENTI-DATI-COMPARISON.md`

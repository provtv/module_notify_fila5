...
## Obiettivo
Portare la pagina locale `http://127.0.0.1:8000/it/tests/segnalazione-area-personale` al **95%+ di parità visiva e strutturale** con il riferimento Bootstrap Italia.
...
## Descrizione
Personal area reports dashboard.

## Attività
- [ ] Fetch reference HTML: `curl -sL https://italia.github.io/design-comuni-pagine-statiche/sito/segnalazione-area-personale.html > docs/visual-comparison/reference-segnalazione-area-personale.html`
- [ ] Fetch local HTML: `curl -s http://127.0.0.1:8000/it/tests/segnalazione-area-personale > docs/visual-comparison/local-segnalazione-area-personale.html`
- [ ] Analyze structural differences (body content, excluding scripts)
- [ ] Screenshot comparison (reference vs local at 1920x1080)
- [ ] Create/update JSON content file: `config/.../content/pages/tests.segnalazione-area-personale.json`
...
- [ ] Update comparison doc: `docs/visual-comparison/SEGNALAZIONE-AREA-PERSONALE-COMPARISON.md`
